"""Update UserBot code (for Xtra-Telegram MOD V2.0)
Syntax: .update
\nAll Credits goes to © @Three_Cube_TeKnoways
\nFor this awasome plugin.\nPorted from PpaperPlane Extended"""
#Ported To X-tra-TG BOT mod v2.0
...
async def updater(message):
    ...
    if not changelog:
        await message.edit("`Connecting To HeroKU Server.... `")
    ...
    if Var.HEROKU_API_KEY is not None:
        ...
        await message.edit("Add API Key In`HEROKU_API_KEY` var Nibba")
...
async def deploy_start(tgbot, message, refspec, remote):
    ...
    await message.edit("Updating and Deploying [X-tra-Telegram MOD V2.0](https://dashboard.heroku.com/apps/bootie/deploy) Master Branch Is Being Deployed. This usually takes some time. So, Be Patient Nibba.\n\nIf X-Tra-TG MOD V2.0 doesn't work, then check [LOGS](https://dashboard.heroku.com/apps/bootie/logs)")
